...
Official couchdb plugin for dokku. Currently defaults to installing [couchdb 3.1.1](https://hub.docker.com/_/couchdb/).
...
```shell
dokku couchdb:import lolipop < backup-folder/export
```
