...
couchdb:info <service> [--single-info-flag]        # print the connection information
...
```shell
export COUCHDB_IMAGE="${PLUGIN_IMAGE}"
...
```shell
dokku couchdb:expose lolipop ${PLUGIN_DATASTORE_PORTS[@]}
```
